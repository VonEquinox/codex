...
- `worktree: true` creates a dedicated git worktree for that teammate. If hooks later override worktree creation/removal, the persisted lease still keeps cleanup restart-safe.
